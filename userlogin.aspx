<%@ Page Title="" Language="C#" MasterPageFile="~/UserMasterPage1.master" AutoEventWireup="true" CodeFile="userlogin.aspx.cs" Inherits="userlogin" %>
    ...
    <table>
            ...
            <tr>
                <td class="auto-style5">
                    <asp:LinkButton ID="lkforgot" runat="server" Text="Forgot Password?" PostBackUrl="~/forgotpwd.aspx"  Font-Bold="True" Font-Underline="True" Font-Size="Large" OnClick="lkforgot_Click"></asp:LinkButton> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <asp:LinkButton ID="lkregister" runat="server" Text="Create New Account" PostBackUrl="Registration.aspx" Font-Bold="True" Font-Size="Large" Font-Underline="True" OnClick="lkregister_Click"></asp:LinkButton>
        ...
        <img src="image/banners/1.jpg" style="width: 903px; height: 410px;" alt="login page"/>
